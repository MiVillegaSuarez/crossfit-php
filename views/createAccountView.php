...
<head>
    ...
    <!-- Titulo -->
    <title>Crear Cuenta | El Camino Hacia Una Mejor Salud</title>
            ...
            <div class="col-sm-12 col-lg-12">
                ...
                <form class="create-sec-01-form">
                    ...
                    <div class="mb-3 form-check create-sec-01-check">
                        ...
                        <label class="form-check-label" for="exampleCheck1">I have read and agree to CrossFit’s <span>Terms & Conditions</span></label>
                    </div>
                    <div class="mb-3 form-check create-sec-01-check">
                        <input type="checkbox" class="form-check-input" id="exampleCheck1">
